    ...
    inner: [
      {
        identifier: "intro",
        inner: `\
На данном сайте Вы можете создать свое ТЗ(ЧТЗ) по встроенным шаблонам СТО "РЖД" для заявок на реализацию информационных систем. 
Внимательно читайте описание того, что именно нужно написать в предложенные ячейки. 
Также, наведя курсор на значок информации рядом с пунктом ввода, Вы можете ознакомиться с примером заполнения данного пункта. 
Не забывайте сохранять внесенные данные в ячейках с помощью кнопки "Сохранить ячейку" или "Сохранить все ячейки", чтобы при выходе и возвращении обратно на данный сайт, Вы могли просто нажать кнопку "Загрузить ячейку" или "Загрузить все ячейки" и во всех Ваших заполненных до этого момента ячейках появились сохраненные данные. 
После окончания заполнения каждого раздела нажимайте кнопку "Подтвердить", чтобы сохранить и добавить раздел в будущий документ. 
Передвигайтесь по разделам заполнения ТЗ(ЧТЗ) с помощью стрелок по бокам раздела или с помощью номеров разделов внизу экрана.
После заполнения всех разделов ТЗ(ЧТЗ) нажмите кнопку "Подтвердить", а затем "Сохранить docx файл" внизу экрана. После этого в Вас в Загрузках Вашего компьютера появится готовый  WORD-ский файл Вашего ТЗ(ЧТЗ).
Чтобы приступить к составлению Вашего ТЗ(ЧТЗ), нажмите красную стрелочку справа или перейдите в следующий раздел внизу экрана. `,
      },
    ],
  },
  {
